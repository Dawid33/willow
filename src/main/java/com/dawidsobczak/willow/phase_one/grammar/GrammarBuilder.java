...
import com.dawidsobczak.willow.phase_one.arithmetic.ArithemticGrammarSymbols;
...
public class GrammarBuilder {
    public static Grammar<WillowGrammarSymbols> buildDsGrammar() throws GrammarException {
        ArrayList<Rule<WillowGrammarSymbols>> rules = new ArrayList<>();

        var chunk = WillowGrammarSymbols.CHUNK;

        var endfile = WillowGrammarSymbols.ENDFILE;
        var block = WillowGrammarSymbols.BLOCK;

        rules.add(new Rule<>(chunk, new WillowGrammarSymbols[]{block, endfile}));

        var terminals = new ArrayList<>(List.of(endfile));
        var nonTerminals = new ArrayList<>(List.of(new WillowGrammarSymbols[]{}));

        Grammar<WillowGrammarSymbols> g = new Grammar<>(rules, terminals, nonTerminals, chunk, WillowGrammarSymbols.DELIM);
        return g;
    }
